...
async function vizualizarInformacoesGlobais() {
  ...
  aproximadamente <span>${pessoasConectadas} bilhões</span> estão conectadas em alguma rede social e passam 
  em média <span>${horas}</span> horas e <span>${minutos} minutos</span> conectadas.<br>Isso significa que 
